...
#If you notice, all models predict the same value for all the 3 years respectively. The predicted values may differ from model to model but it is the same within the model. This happens because the data has no seasonality or specific trend. The model will just calculate the average and post the values out.
